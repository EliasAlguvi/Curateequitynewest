...
export const Route = createFileRoute('/perspectives/specialist-managers')({
  component: SpecialistManagersPage,
})

type Article = (typeof perspectiveArticles)[string]

function SpecialistManagersPage() {
  const article = perspectiveArticles['specialist-managers']
  return (
    <>
      <SiteNav />
