...
export const Route = createFileRoute('/perspectives/institutional-platforms')({
  component: InstitutionalPlatformsPage,
})

type Article = (typeof perspectiveArticles)[string]

function InstitutionalPlatformsPage() {
  const article = perspectiveArticles['institutional-platforms']
  return (
    <>
      <SiteNav />
